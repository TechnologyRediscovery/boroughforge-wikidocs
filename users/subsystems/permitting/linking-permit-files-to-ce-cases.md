...
To get to a permit file: open a property profile, find the permit file inside a unit in the upper-right column, and click the **view permit file** link. See [Creating permit files](/users/subsystems/permitting/creating-permit-files) if you need a refresher on reaching a permit file.
