...
See the [hub page](/system/subsystems/communication) for links to the other branches, and the [subsystem registry](/system/subsystem-registry) entry #17 for scope notes.
