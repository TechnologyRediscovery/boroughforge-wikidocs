...
| 21 | [`public-applications`](/system/subsystems/public-applications) (pub-apps)| Public Applications | *(none)* | `viv_occapp_publicforms` | Renamed from `permit-applications`. Covers all public-facing application intake: rental registration applications, permit applications, inspection requests, and zoning applications. |
